<?php
    session_save_path(__DIR__ . "/src/incs/statistic/session");
    session_start();
    include_once './src/incs/statistic/statistics.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<div class="container">
        <a href="./src/php/login.php" class="admin">Войти в режим администратора</a>
